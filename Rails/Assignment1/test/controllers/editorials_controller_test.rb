...
class EditorialsControllerTest < ActionController::TestCase
  ...
  test "should create editorial" do
    assert_difference('Editorial.count') do
      post :create, editorial: { author: @editorial.author, content: @editorial.content, date: @editorial.date, image: @editorial.image, published: @editorial.published, title: @editorial.title }
    end
  ...
  test "should update editorial" do
    patch :update, id: @editorial, editorial: { author: @editorial.author, content: @editorial.content, date: @editorial.date, image: @editorial.image, published: @editorial.published, title: @editorial.title }
    assert_redirected_to editorial_path(assigns(:editorial))
  end
